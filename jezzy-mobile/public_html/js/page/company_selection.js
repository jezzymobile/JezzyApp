    ...
    $.ajax({
        ...
        for(var i=0;i<convertedReturns2.length;i++) {
            ...
            $.ajax({
                ...
                $("#conteudo").append("<div class='row centerLogoJezzy' id='id"+convertedReturns2Company.Company.id+"'><div class='logo'><img src='"+convertedReturns2Company.Company.logo+"'></div><div id='service_class' class='tablecontent' onclick='Click("+objReturn1+")'>"+convertedReturns2Company.Company.fancy_name+"</div></div><div class='bottomLine2'></div>");
                }
                }
            }).error(function (XMLHttpRequest, textStatus, errorThrown) {
                alert(errorThrown);
