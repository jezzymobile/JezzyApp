...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Mail->Helo = '192.168.1.41:8080.localdomain';
    ...
    public function checkChanges()
    {
        ...
        if ($this->Mail->Helo != '192.168.1.41:8080.localdomain') {
...
EOT;
    ...
    public function testPopBeforeSmtpGood()
    {
        ...
        $this->assertTrue(
            POP3::popBeforeSmtp('192.168.1.41:8080', 1100, 10, 'user', 'test', $this->Mail->SMTPDebug),
    ...
    public function testPopBeforeSmtpBad()
    {
        ...
        $this->assertFalse(
            POP3::popBeforeSmtp('192.168.1.41:8080', 1101, 10, 'user', 'xxx', $this->Mail->SMTPDebug),
    ...
    public function testSmtpConnect()
    {
        ...
        $this->Mail->smtpClose();
        $this->Mail->Host = "ssl://192.168.1.41:8080:12345;tls://192.168.1.41:8080:587;10.10.10.10:54321;192.168.1.41:8080:12345;10.10.10.10";
        $this->assertFalse($this->Mail->smtpConnect(), 'SMTP bad multi-connect succeeded');
        $this->Mail->smtpClose();
        $this->Mail->Host = "192.168.1.41:8080:12345;10.10.10.10:54321;" . $_REQUEST['mail_host'];
        $this->assertTrue($this->Mail->smtpConnect(), 'SMTP multi-connect failed');
        $this->Mail->smtpClose();
        $this->Mail->Host = " 192.168.1.41:8080:12345 ; " . $_REQUEST['mail_host'] . ' ';
